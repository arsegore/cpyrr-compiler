...
declaration_variable  : VAR IDF DP nom_type {determiner_ligne_decla($2); remplir_debut_decla(decla_courante, ligne_courante); remplir_nature(decla_courante, N_VAR); remplir_region(decla_courante, num_region_courante); remplir_desc(decla_courante, $4); remplir_exec($2); incr_depl($4); remplir_fin_decla(decla_courante, ligne_courante);}
                      ;
